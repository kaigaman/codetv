...
print('\n=== MYSQL CONTAINER NETWORKS ===')
r('docker inspect codetv-mysql-1 --format "{{json .NetworkSettings.Networks}}" 2>&1', 10)
print('\n=== RECREATE CONTAINER ===')
r('docker compose -f /opt/codetv/docker-compose.yml up -d laravel --force-recreate 2>&1', 30)
r('sleep 3; docker inspect codetv-laravel-1 --format "{{json .NetworkSettings.Networks}}" 2>&1', 10)
print('\n=== TEST CONNECTION ===')
